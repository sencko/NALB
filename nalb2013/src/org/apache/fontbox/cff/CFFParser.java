...
public class CFFParser {
  ...
  private CFFFont parseFont(int index) throws IOException {
    ...
    font.addValueToTopDict(
        ...
        getArray(
            topDict,
            "FontMatrix",
            Arrays.<Number> asList(Double.valueOf(0.001), Double.valueOf(0), Double.valueOf(0), Double.valueOf(0.001), Double.valueOf(0),
                Double.valueOf(0))));
    font.addValueToTopDict("UniqueID", getNumber(topDict, "UniqueID", null));
    font.addValueToTopDict("FontBBox",
        getArray(topDict, "FontBBox", Arrays.<Number> asList(Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0))));
  ...
  private static class Format0Encoding extends EmbeddedEncoding {
    ...
    @Override
    public String toString() {
      return getClass().getName() + "[format=" + format + ", nCodes=" + nCodes + ", code=" + Arrays.toString(code) + ", supplement="
  ...
  private static class Format1Encoding extends EmbeddedEncoding {
    ...
    @Override
    public String toString() {
      return getClass().getName() + "[format=" + format + ", nRanges=" + nRanges + ", range=" + Arrays.toString(range) + ", supplement="
          + Arrays.toString(super.supplement) + "]";
    }
