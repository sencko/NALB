...
public class CharStringConverter extends CharStringHandler {
  ...
  private List<Integer> handleType2Command(List<Integer> numbers, CharStringCommand command) {
    ...
    if ("hflex".equals(name)) {
      List<Integer> first = Arrays.asList(numbers.get(0), Integer.valueOf(0), numbers.get(1), numbers.get(2), numbers.get(3), Integer.valueOf(0));
      List<Integer> second = Arrays.asList(numbers.get(4), Integer.valueOf(0), numbers.get(5), Integer.valueOf(-numbers.get(2).intValue()),
      ...
      List<Integer> first = Arrays.asList(numbers.get(0), numbers.get(1), numbers.get(2), numbers.get(3), numbers.get(4), Integer.valueOf(0));
      List<Integer> second = Arrays.asList(numbers.get(5), Integer.valueOf(0), numbers.get(6), numbers.get(7), numbers.get(8), Integer.valueOf(0));
      addCommandList(Arrays.asList(first, second), new CharStringCommand(8));
      ...
      List<Integer> first = numbers.subList(0, 6);
      List<Integer> second = Arrays.asList(numbers.get(6), numbers.get(7), numbers.get(8), numbers.get(9),
  ...
  private List<Integer> clearStack(List<Integer> numbers, boolean flag) {
    ...
    if (sequence.size() == 0) {
      if (flag) {
        addCommand(Arrays.asList(Integer.valueOf(0), Integer.valueOf(numbers.get(0).intValue() + nominalWidthX)), new CharStringCommand(13));

        numbers = numbers.subList(1, numbers.size());
      } else {
        addCommand(Arrays.asList(Integer.valueOf(0), Integer.valueOf(defaultWidthX)), new CharStringCommand(13));
      }
    }
  ...
  private void closePath() {
    CharStringCommand command = pathCount > 0 ? (CharStringCommand) sequence.get(sequence.size() - 1) : null;
  ...
  private void drawAlternatingCurve(List<Integer> numbers, boolean horizontal) {
    while (numbers.size() > 0) {
      ...
      if (horizontal) {
        addCommand(
            Arrays.asList(numbers.get(0), Integer.valueOf(0), numbers.get(1), numbers.get(2), last ? numbers.get(4) : Integer.valueOf(0),
                numbers.get(3)), new CharStringCommand(8));
      } else {
        addCommand(
            Arrays.asList(Integer.valueOf(0), numbers.get(0), numbers.get(1), numbers.get(2), numbers.get(3),
                last ? numbers.get(4) : Integer.valueOf(0)), new CharStringCommand(8));
      }
  ...
  private void drawCurve(List<Integer> numbers, boolean horizontal) {
    while (numbers.size() > 0) {
      ...
      if (horizontal) {
        addCommand(
            Arrays.asList(numbers.get(first ? 1 : 0), first ? numbers.get(0) : Integer.valueOf(0), numbers.get(first ? 2 : 1),
                numbers.get(first ? 3 : 2), numbers.get(first ? 4 : 3), Integer.valueOf(0)), new CharStringCommand(8));
      } else {
        addCommand(
            Arrays.asList(first ? numbers.get(0) : Integer.valueOf(0), numbers.get(first ? 1 : 0), numbers.get(first ? 2 : 1),
                numbers.get(first ? 3 : 2), Integer.valueOf(0), numbers.get(first ? 4 : 3)), new CharStringCommand(8));
      }
