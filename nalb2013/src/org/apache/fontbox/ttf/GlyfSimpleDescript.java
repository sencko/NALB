...
public class GlyfSimpleDescript extends GlyfDescript {
  ...
  public GlyfSimpleDescript( short numberOfContours, TTFDataStream bais) throws IOException {
    ...
    /*
     * https://developer.apple.com/fonts/TTRefMan/RM06/Chap6glyf.html "If a glyph has zero contours, it need not have any glyph data." set the
     * pointCount to zero to initialize attributes and avoid nullpointer but maybe there shouldn't have GlyphDescript in the GlyphData?
     */
