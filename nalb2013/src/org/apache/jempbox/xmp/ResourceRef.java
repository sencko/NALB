...
public class ResourceRef implements Elementable {
  ...
  public ResourceRef( Element parentElement) {
    ...
    if (!parent.hasAttribute("xmlns:stRef")) {
      parent.setAttributeNS(XMPSchema.NS_NAMESPACE, "xmlns:stRef", "http://ns.adobe.com/xap/1.0/sType/ResourceRef#");
    }
  }
  ...
  /**
   * Set the rendition class. The rendition class is derived from a defined set of names. The value is series of colon separated tokens and
   * parameters.<br/>
   ...
   * <tr>
   * <td>default</td>
   * <td>Specifies master document, no additional tokens allowed</td>
   * </tr>
   * <tr>
   * <td>thumbnail</td>
   * <td>A simplied preview. Recommended order is: thumbnail<i>format:size:colorspace</i></td>
   * </tr>
   * <tr>
   * <td>screen</td>
   ...
   * <tr>
   * <td>proof</td>
   * <td>A review proof</td>
   * </tr>
   * <tr>
   * <td>draft</td>
   * <td>A review rendition</td>
   * </tr>
   * <tr>
   * <td>low-res</td>
   * <td>A low resolution, full size stand-in</td>
   * <tr>
   * </table>
   * 
   * 
