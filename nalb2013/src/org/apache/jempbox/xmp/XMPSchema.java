...
/**
 * This class represents a metadata schema that can be stored in an XMP document. It handles all generic properties that are available. See subclasses
 * for access to specific properties.
 * 
...
public class XMPSchema {
   ...
   * 
   * @param parent The parent XMP document that this schema will be part of.
   * @param namespaceName The name of the namespace, ie pdf,dc,...
   * @param namespaceURI The URI of the namespace, ie "http://ns.adobe.com/pdf/1.3/"
   */
  public XMPSchema( XMPMetadata parent, String namespaceName, String namespaceURI) {
    schema = parent.xmpDocument.createElementNS("http://www.w3.org/1999/02/22-rdf-syntax-ns#", "rdf:Description");
    prefix = namespaceName;
    schema.setAttributeNS(NS_NAMESPACE, "xmlns:" + namespaceName, namespaceURI);
  }
   ...
   * 
   * @param about The new RFD about value.
   */
   ...
   * 
   * @param propertyName The name of the property, it must contain the namespace prefix, ie "pdf:Keywords"
   * @param propertyValue The value for the property, can be any string. Passing null will remove the property.
   */
    ...
    if (propertyValue == null) {
      ...
      if (schema.hasAttribute(propertyName)) {
        ...
        if (schema.hasChildNodes()) {
          NodeList nodeList = schema.getElementsByTagName(propertyName);
   ...
   * 
   * @param propertyName The name of the property to get, it must include the namespace prefix. ie "pdf:Keywords".
   * 
   ...
   * 
   * @param propertyName The fully qualified property name for the date.
   * 
   ...
   * 
   * @param propertyName The fully qualified property name for the boolean.
   * 
   ...
   * 
   * @param propertyName The fully qualified property name for the boolean.
   * @param bool The boolean to set, or null to clear.
   */
   ...
   * 
   * @param propertyName The fully qualified property name for the integer.
   * 
   ...
   * 
   * @param propertyName The fully qualified property name for the integer.
   * @param intValue The int to set, or null to clear.
   */
   ...
   * 
   * @param bagName The name of the bag, it must include the namespace prefix. ie "pdf:Keywords".
   * @param bagValue The value to remove from the bagList.
   */
   ...
   * 
   * @param bagName The name of the bag, it must include the namespace prefix. ie "pdf:Keywords".
   * @param bagValue The value to add to the bagList.
   */
  public void addBagValue(String bagName, String bagValue) {
    ...
    if (nodes.getLength() > 0) {
      ...
      Element contElement = schema.getOwnerDocument().createElement(bagName);
   ...
   * 
   * @param bagName The name of the bag property to get, it must include the namespace prefix. ie "pdf:Keywords"
   * 
   ...
   * 
   * @param seqName The name of the sequence property. It must include the namespace prefix. ie "pdf:Keywords".
   * @param seqValue The value to remove from the list.
   */
   ...
   * 
   * @param seqName The name of the sequence property, it must include the namespace prefix. ie "pdf:Keywords"
   * @param seqValue The value to add to the sequence.
   */
  public void addSequenceValue(String seqName, String seqValue) {
    ...
    if (bagElement == null) {
      Element contElement = schema.getOwnerDocument().createElement(seqName);
      schema.appendChild(contElement);
      bagElement = schema.getOwnerDocument().createElement("rdf:Seq");
      contElement.appendChild(bagElement);
    }
    Element liElement = schema.getOwnerDocument().createElement("rdf:li");
    liElement.appendChild(schema.getOwnerDocument().createTextNode(seqValue));
    bagElement.appendChild(liElement);
  }
   ...
   * 
   * @param seqName The name of the sequence to retrieve.
   * 
   ...
   * 
   * @param seqName The name of the sequence property, it must include the namespace prefix. ie "pdf:Keywords"
   * @param date The date to remove from the sequence property.
   */
   ...
   * 
   * @param seqName The name of the sequence property, it must include the namespace prefix. ie "pdf:Keywords"
   * @param date The date to add to the sequence property.
   */
   ...
   * 
   * @param propertyName The name of the property, it must include the namespace prefix. ie "pdf:Keywords"
   * @param language The language code of the value. If null then "x-default" is assumed.
   * @param value The value of the property in the specified language.
   */
