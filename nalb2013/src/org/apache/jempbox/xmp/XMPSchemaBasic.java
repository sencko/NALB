...
public class XMPSchemaBasic extends XMPSchema {
  ...
  public XMPSchemaBasic( XMPMetadata parent) {
    ...
    schema.setAttributeNS(NS_NAMESPACE, "xmlns:xapGImg", "http://ns.adobe.com/xap/1.0/g/img/");
  }
   ...
   * 
   * @param advisory An xpath expression specifying properties that were edited outside of the authoring application.
   */
