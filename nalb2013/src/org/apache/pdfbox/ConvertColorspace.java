...
public class ConvertColorspace {
  ...
  private void replaceRGBTokensWithCMYKTokens(List editedPageTokens, List pageTokens, int counter, Hashtable colorEquivalents) {
    ...
    if (cmykColor != null) {
      cmyk = new float[] { cmykColor.colorspaceValues[0] / 100.0f, cmykColor.colorspaceValues[1] / 100.0f, cmykColor.colorspaceValues[2] / 100.0f,
  ...
  private static class ColorSpaceInstance {
    ...
    public boolean equals(Object o) {
      ...
      if (o instanceof ColorSpaceInstance) {
        ...
        if (this.colorspace.equals(other.colorspace) && (colorspaceValues.length == other.colorspaceValues.length)) {
          retval = true;
