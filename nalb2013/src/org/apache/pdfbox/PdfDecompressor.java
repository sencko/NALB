...
/**
 * This program will just take all of the stream objects in a PDF and dereference them. The streams will be gone in the resulting file and the objects
 * will be present. This is very helpful when trying to debug problems as it'll make it possible to easily look through a PDF using a text editor. It
 * also exposes problems which stem from objects inside object streams overwriting other objects.
 * 
