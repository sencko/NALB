...
public class WriteDecodedDoc {
  ...
  /**
   * This will write a PDF document with completely decoded streams. <br />
  ...
  private static void usage() {
    System.err
        .println("usage: java -jar pdfbox-app-x.y.z.jar WriteDecodedDoc [OPTIONS] <input-file> [output-file]\n"
