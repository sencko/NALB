...
public class COSArray extends COSBase implements Iterable<COSBase> {
  ...
  /**
   * This will add null values until the size of the array is at least as large as the parameter. If the array is already larger than the parameter
  ...
  /**
   * This will add the object until the size of the array is at least as large as the parameter. If the array is already larger than the parameter
   * then nothing is done.
   * 
   * @param size The desired size of the array.
