...
public class COSStream extends COSDictionary {
  ...
  /**
   * This will replace this object with the data from the new object. This is used to easily maintain referential integrity when changing references
   * to new objects.
   * 
  ...
  public InputStream getFilteredStream() throws IOException {
    ...
    RandomAccessFileInputStream input = new RandomAccessFileInputStream(file, position, length);
  ...
  /**
   * This will return the filters to apply to the byte stream. The method will return - null if no filters are to be applied - a COSName if one filter
   * is to be applied - a COSArray containing COSNames if multiple filters are to be applied
   * 
  ...
  /**
   * This will create a new stream for which filtered byte should be written to. You probably don't want this but want to use the
