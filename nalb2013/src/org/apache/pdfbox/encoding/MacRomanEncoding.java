...
public class MacRomanEncoding extends Encoding {
  ...
  public String getName(int code) throws IOException {
    if (!codeToName.containsKey(code) && (code == 0312)) {
      /*
       * The space character is also encoded as 0312 in MacRoman and 0240 in WinAnsi. The meaning of this duplicate code is "nonbreaking space" but it
       * is typographically the same as space.
       */
      return "space";
    }
