...
/**
 * EncodingConversionManager maintains relationship between PDF encoding name and respective EncodingConverter instance. Those PDF encoding name like
 * GBK-EUC-H should be converted to java charset name before constructing a java string instance
 * 
