...
public class JBIG2Filter implements Filter {
  ...
  public void decode(InputStream compressedData, OutputStream result, COSDictionary options, int filterIndex) throws IOException {
    /**
     * A working JBIG2 ImageIO plugin is needed to decode JBIG2 encoded streams. The following is known to be working. It can't be bundled with PDFBox
     * because of an incompatible license. http://code.google.com/p/jbig2-imageio/
     */
