...
public class IOUtils {
  ...
  /**
   * Populates the given buffer with data read from the input stream. If the data doesn't fit the buffer, only the data that fits in the buffer is
   * read. If the data is less than fits in the buffer, the buffer is not completely filled.
   * 
   * @param in the input stream to read from
