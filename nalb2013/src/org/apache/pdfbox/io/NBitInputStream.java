...
/**
 * This is an n-bit input stream. This means that you can read chunks of data as any number of bits, not just 8 bits like the regular input stream.
 * Just set the number of bits that you would like to read on each call. The default is 8.
 * 
