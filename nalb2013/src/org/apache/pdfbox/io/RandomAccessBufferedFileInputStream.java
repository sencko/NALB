...
/**
 * Provides {@link InputStream} access to portions of a file combined with buffered reading of content. Start of next bytes to read can be set via
 * seek method.
 * 
...
public class RandomAccessBufferedFileInputStream extends InputStream implements RandomAccessRead {
  ...
  // ------------------------------------------------------------------------
  /**
   * Reads a page with data from current file position. If we have a previously removed page from cache the buffer of this page is reused. Otherwise a
   * new byte buffer is created.
   */
