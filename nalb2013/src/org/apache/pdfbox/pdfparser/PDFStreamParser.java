...
public class PDFStreamParser extends BaseParser {
  ...
  private Object parseNextToken() throws IOException {
    ...
    switch (c) {
      ...
      case '.': {
        /*
         * We will be filling buf with the rest of the number. Only allow 1 "." and "-" and "+" at start of number.
         */
      ...
      case 'I': {
        ...
        while (!(isWhitespace(twoBytesAgo) && (lastByte == 'E') && (currentByte == 'I') && isWhitespace() // &&
  ...
  protected String readOperator() throws IOException {
    ...
    while ((nextChar != -1)
        && // EOF
        !isWhitespace(nextChar) && !isClosing(nextChar) && (nextChar != '[') && (nextChar != '<') && (nextChar != '(') && (nextChar != '/')
