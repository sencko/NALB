...
public class PDDocumentCatalog implements COSObjectable {
  ...
  public PDAcroForm getAcroForm() {
    if (acroForm == null) {
      COSDictionary acroFormDic = (COSDictionary) root.getDictionaryObject(COSName.ACRO_FORM);
      if (acroFormDic != null) {
  ...
  /**
   * The PDF document contains a hierarchical structure of PDPageNode and PDPages, which is mostly just a way to store this information. This method
   * will return a flat list of all PDPage objects in this document.
   * 
