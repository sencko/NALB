...
public class PDPageNode implements COSObjectable {
  ...
  /**
   * This will update the count attribute of the page node. This only needs to be called if you add or remove pages. The PDDocument will call this for
   * you when you use the PDDocumnet persistence methods. So, basically most clients will never need to call this.
   * 
  ...
  /**
   * This will get the resources at this page node and not look up the hierarchy. This attribute is inheritable, and findResources() should probably
   * used. This will return null if no resources are available at this level.
   * 
