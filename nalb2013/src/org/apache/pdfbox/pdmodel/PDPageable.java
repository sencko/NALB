...
/**
 * Adapter class that implements the {@link Pageable} and {@link Printable} interfaces for printing a given PDF document. Note that the given PDF
 * document should not be modified (pages added, removed, etc.) while an instance of this class is being used.
 * 
...
public class PDPageable // implements Pageable, Printable
{
  ...
  /**
   * Creates a {@link Pageable} adapter for the given PDF document using a default printer job returned by {@link PrinterJob#getPrinterJob()}.
   * 
   * @param document PDF document
  ...
  /**
   * Returns a {@link Printable} for the page at the given index. Currently this method simply returns the underlying {@link PDPage} object that
   * directly implements the {@link Printable} interface, but future versions may choose to return a different adapter instance.
   * 
   * @param i page index, zero-based
   * @return printable
   * @throws IndexOutOfBoundsException if the page index is invalid
   ...
   * @param i page index, zero-based
   * @return {@link Printable#PAGE_EXISTS} if the page was printed, or {@link Printable#NO_SUCH_PAGE} if page index was invalid
