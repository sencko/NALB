...
public class PDResources implements COSObjectable {
  ...
  /**
   * This will get the map of images. An empty map will be returned if there are no underlying images. So far the keys are COSName of the image and
   * the value is the corresponding PDXObjectImage.
   * 
   * @author By BM
  ...
  /**
   * This will get the map of colorspaces. This will return null if the underlying resources dictionary does not have a colorspace dictionary. The
   * keys are string and the values are PDColorSpace objects.
   * 
  ...
  /**
   * This will get the map of graphic states. This will return null if the underlying resources dictionary does not have a graphics dictionary. The
   * keys are the graphic state name as a String and the values are PDExtendedGraphicsState objects.
   * 
  ...
  /**
   * This will get the map of patterns. This will return null if the underlying resources dictionary does not have a patterns dictionary. The keys are
   * the pattern name as a String and the values are PDPatternResources objects.
   * 
  ...
  /**
   * This will get the map of shadings. This will return null if the underlying resources dictionary does not have a shading dictionary. The keys are
   * the shading name as a String and the values are PDShadingResources objects.
   * 
