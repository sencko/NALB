...
public class PDNameTreeNode implements COSObjectable {
  ...
  /**
   * This will return a map of names. The key will be a string, and the value will depend on where this class is being used.
   * 
  ...
  /**
   * Method to convert the COS value in the name tree to the PD Model object. The default implementation will simply return the given COSBase object.
