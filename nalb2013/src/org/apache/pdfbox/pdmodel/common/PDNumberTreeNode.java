 ...
 * 
 * @author <a href="mailto:ben@benlitchfield.com">Ben Litchfield</a>, <a href="igor.podolskiy@ievvwi.uni-stuttgart.de">Igor Podolskiy</a>
...
public class PDNumberTreeNode implements COSObjectable {
  ...
  /**
   * Method to convert the COS value in the name tree to the PD Model object. The default implementation will simply use reflection to create the
   * correct object type. Subclasses can do whatever they want.
   * 
  ...
  /**
   * Set the names of for this node. The keys should be java.lang.String and the values must be a COSObjectable. This method will set the appropriate
   * upper and lower limits based on the keys in the map.
   * 
