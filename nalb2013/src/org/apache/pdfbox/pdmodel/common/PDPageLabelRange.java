...
public class PDPageLabelRange implements COSObjectable {
   ...
   * 
   * @param style one of the STYLE_* constants or {@code null} if no page numbering is desired.
   */
   ...
   * 
   * @return the page label prefix for this page range, or {@code null} if no prefix has been defined.
   */
   ...
   * 
   * @param prefix the page label prefix for this page range, or {@code null} to unset the prefix.
   */
