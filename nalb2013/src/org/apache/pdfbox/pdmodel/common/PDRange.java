...
public class PDRange implements COSObjectable {
  ...
  /**
   * Constructor with an index into an array. Because some arrays specify multiple ranges ie [ 0,1, 0,2, 2,3 ] It is convenient for this class to take
   * an index into an array. So if you want this range to represent 0,2 in the above example then you would say <code>new PDRange( array, 1 )</code>.
   * 
