...
public class PDRectangle implements COSObjectable {
  ...
  /**
   * This will create a translated rectangle based off of this rectangle, such that the new rectangle retains the same dimensions(height/width), but
   * the lower left x,y values are zero. <br />
