...
/**
 * A PDTextStream class is used when the PDF specification supports either a string or a stream for the value of an object. This is usually when a
 * value could be large or small, for example a JavaScript method. This class will help abstract that and give a single unified interface to those
 * types of fields.
 * 
...
public class PDTextStream implements COSObjectable {
  ...
  /**
   * This will get this value as a string. If this is a stream then it will load the entire stream into memory, so you should only do this when the
   * stream is a manageable size.
   * 
