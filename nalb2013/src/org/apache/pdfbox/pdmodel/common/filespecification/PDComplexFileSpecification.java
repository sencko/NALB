...
public class PDComplexFileSpecification extends PDFileSpecification {
   ...
   * </p>
   * <p>
   * First of all we try to get the unicode filename if it exist. If it doesn't exist we take a look at the DOS, MAC UNIX filenames. If no one exist
   * the required F entry will be returned.
   * </p>
   * 
