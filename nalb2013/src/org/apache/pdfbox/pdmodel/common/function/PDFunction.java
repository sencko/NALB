...
public abstract class PDFunction implements COSObjectable {
  ...
  /**
   * This will get the number of output parameters that have a range specified. A range for output parameters is optional so this may return zero for
   * a function that does have output parameters, this will simply return the number that have the rnage specified.
   * 
  ...
  /**
   * This will get the range for a certain output parameters. This is will never return null. If it is not present then the range 0 to 0 will be
   * returned.
   * 
  ...
  /**
   * This will get the range for a certain input parameter. This is will never return null. If it is not present then the range 0 to 0 will be
   * returned.
   * 
   ...
   * 
   * @param input The COSArray of input values for the function. In many cases will be an array of a single value, but not always.
   * 
   * @return The of outputs the function returns based on those inputs. In many cases will be an COSArray of a single value, but not always.
   * 
  ...
  /**
   * For a given value of x, interpolate calculates the y value on the line defined by the two points (xRangeMin , xRangeMax ) and (yRangeMin ,
   * yRangeMax ).
   * 
