...
public class PDObjectReference implements COSObjectable {
  ...
  /**
   * Gets a higher-level object for the referenced object. Currently this method may return a {@link PDAnnotation}, a {@link PDXObject} or
   * <code>null</code>.
   * 
  ...
  public COSObjectable getReferencedObject() {
    ...
    try {
      ...
      /*
       * COSName.TYPE is optional, so if annotation is of type unknown and COSName.TYPE is not COSName.ANNOT it still may be an annotation. TODO shall
       * we return the annotation object instead of null? what else can be the target of the object reference?
       */
