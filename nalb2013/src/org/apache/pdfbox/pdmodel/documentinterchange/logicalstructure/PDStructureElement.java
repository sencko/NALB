 ...
 * A structure element.
 * 
 * @author <a href="mailto:ben@benlitchfield.com">Ben Litchfield</a>, <a href="mailto:Johannes%20Koch%20%3Ckoch@apache.org%3E">Johannes Koch</a>
...
public class PDStructureElement extends PDStructureNode {
  ...
  public PDStructureNode getParent() {
    COSDictionary p = (COSDictionary) this.getCOSDictionary().getDictionaryObject(COSName.P);
    if (p == null) {
      return null;
    }
   ...
   * 
   * @return the page on which some or all of the content items designated by the K entry shall be rendered
   */
  public PDPage getPage() {
    COSDictionary pageDic = (COSDictionary) this.getCOSDictionary().getDictionaryObject(COSName.PG);
    if (pageDic == null) {
      return null;
    }
   ...
   * 
   * @param page the page on which some or all of the content items designated by the K entry shall be rendered.
   */
