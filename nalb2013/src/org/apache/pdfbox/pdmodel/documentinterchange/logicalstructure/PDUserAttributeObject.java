...
public class PDUserAttributeObject extends PDAttributeObject {
  ...
  public List<PDUserProperty> getOwnerUserProperties() {
    COSArray p = (COSArray) this.getCOSDictionary().getDictionaryObject(COSName.P);
  ...
  public String toString() {
    return new StringBuilder().append(super.toString()).append(", userProperties=").append(this.getOwnerUserProperties()).toString();
  }
