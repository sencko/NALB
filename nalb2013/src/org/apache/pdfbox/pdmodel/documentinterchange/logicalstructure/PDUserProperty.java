...
public class PDUserProperty extends PDDictionaryWrapper {
   ...
   * 
   * @return <code>true</code> if the property shall be hidden, <code>false</code> otherwise
   */
   ...
   * 
   * @param hidden <code>true</code> if the property shall be hidden, <code>false</code> otherwise
   */
  ...
  public String toString() {
    return new StringBuilder("Name=").append(this.getName()).append(", Value=").append(this.getValue()).append(", FormattedValue=")
        .append(this.getFormattedValue()).append(", Hidden=").append(this.isHidden()).toString();
  }
   ...
   * @param oldEntry old entry
   * @param newEntry new entry
   * @return <code>true</code> if the entry is changed, <code>false</code> otherwise
   */
