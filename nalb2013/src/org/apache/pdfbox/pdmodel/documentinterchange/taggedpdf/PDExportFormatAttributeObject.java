...
public class PDExportFormatAttributeObject extends PDLayoutAttributeObject {
  ...
  /**
   * Gets the list numbering (ListNumbering). The default value is {@link #LIST_NUMBERING_NONE}.
   * 
   ...
   * {@link PDStructureElement#getElementIdentifier()}) for a TH structure element that shall be used as a header associated with this cell.
   * 
   * @return the headers.
   */
  ...
  /**
   * Gets the scope (Scope). It shall reflect whether the header cell applies to the rest of the cells in the row that contains it, the column that
  ...
  /**
   * Sets the scope (Scope). It shall reflect whether the header cell applies to the rest of the cells in the row that contains it, the column that
   * contains it, or both the row and the column that contain it. The value shall be one of the following:
   * <ul>
