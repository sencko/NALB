...
public class PDLayoutAttributeObject extends PDStandardAttributeObject {
  ...
  /**
   * Placement: Before: Placed so that the before edge of the element’s allocation rectangle coincides with that of the nearest enclosing reference
   * area. The element may float, if necessary, to achieve the specified placement. The element shall be treated as a block occupying the full extent
   * of the enclosing reference area in the inline direction. Other content shall be stacked so as to begin at the after edge of the element’s
   * allocation rectangle.
   */
  public static final String PLACEMENT_BEFORE = "Before";
  /**
   * Placement: Start: Placed so that the start edge of the element’s allocation rectangle coincides with that of the nearest enclosing reference
   * area. The element may float, if necessary, to achieve the specified placement. Other content that would intrude into the element’s allocation
   * rectangle shall be laid out as a runaround.
   */
   ...
   * The element may float, if necessary, to achieve the specified placement. Other content that would intrude into the element’s allocation rectangle
   * shall be laid out as a runaround.
   */
  public static final String PLACEMENT_END = "End";
  /**
   * WritingMode: LrTb: Inline progression from left to right; block progression from top to bottom. This is the typical writing mode for Western
   * writing systems.
   */
  public static final String WRITING_MODE_LRTB = "LrTb";
  /**
   * WritingMode: RlTb: Inline progression from right to left; block progression from top to bottom. This is the typical writing mode for Arabic and
   * Hebrew writing systems.
   */
  public static final String WRITING_MODE_RLTB = "RlTb";
  /**
   * WritingMode: TbRl: Inline progression from top to bottom; block progression from right to left. This is the typical writing mode for Chinese and
  ...
  /**
   * TextAlign: Justify: Aligned with both the start and end edges, with internal spacing within each line expanded, if necessary, to achieve such
   * alignment. The last (or only) line shall be aligned with the start edge only.
   */
  ...
  /**
   * BlockAlign: Middle: Children centered within the table cell. The distance between the before edge of the first child’s allocation rectangle and
   * that of the table cell’s content rectangle shall be the same as the distance between the after edge of the last child’s allocation rectangle and
  ...
  /**
   * BlockAlign: Justify: Children aligned with both the before and after edges of the table cell’s content rectangle. The first child shall be placed
   * as described for {@link #BLOCK_ALIGN_BEFORE} and the last child as described for {@link #BLOCK_ALIGN_AFTER}, with equal spacing between the
   * children. If there is only one child, it shall be aligned with the before edge only, as for {@link #BLOCK_ALIGN_BEFORE}.
   */
  ...
  /**
   * InlineAlign: Center: Each child centered within the table cell. The distance between the start edges of the child’s allocation rectangle and the
   * table cell’s content rectangle shall be the same as the distance between their end edges.
   */
  ...
  /**
   * RubyAlign: Distribute: The content shall be expanded to fill the available width in the inline-progression direction. However, space shall also
   * be inserted at the start edge and end edge of the text. The spacing shall be distributed using a 1:2:1 (start:infix:end) ratio. It shall be
   * changed to a 0:1:1 ratio if the ruby appears at the start of a text line or to a 1:1:0 ratio if the ruby appears at the end of the text line.
   */
  ...
  /**
   * Gets the positioning of the element with respect to the enclosing reference area and other content (Placement). The default value is
  ...
  /**
   * Gets the writing mode (WritingMode). The default value is {@link #WRITING_MODE_LRTB}.
   * 
   ...
   * 
   * @return a single border colour ({@link PDGamma}) or four border colours ({@link PDFourColours})
   */
  ...
  /**
   * Gets the border style (BorderStyle). The default value is {@link #BORDER_STYLE_NONE}.
   * 
  ...
  /**
   * Gets the distance from the start edge of the reference area to that of the BLSE in the inline-progression direction (StartIndent). The default
   * value is 0.
   * 
  ...
  /**
   * Gets the distance from the end edge of the BLSE to that of the reference area in the inline-progression direction (EndIndent). The default value
   * is 0.
   * 
  ...
  /**
   * Gets the additional distance in the inline-progression direction from the start edge of the BLSE, as specified by StartIndent, to that of the
   * first line of text (TextIndent). The default value is 0.
   * 
  ...
  /**
   * Sets the additional distance in the inline-progression direction from the start edge of the BLSE, as specified by StartIndent, to that of the
   * first line of text (TextIndent).
   * 
  ...
  /**
   * Gets the alignment, in the inline-progression direction, of text and other content within lines of the BLSE (TextAlign). The default value is
  ...
  /**
   * Sets the alignment, in the inline-progression direction, of text and other content within lines of the BLSE (TextAlign). The value should be one
   * of:
   * <ul>
  ...
  public PDRectangle getBBox() {
    COSArray array = (COSArray) this.getCOSDictionary().getDictionaryObject(BBOX);
    if (array != null) {
  ...
  /**
   * Gets the width of the element’s content rectangle in the inline-progression direction (Width). The default value is {@link #WIDTH_AUTO}.
   * 
  ...
  /**
   * Sets the width of the element’s content rectangle in the inline-progression direction (Width) to {@link #WIDTH_AUTO}.
   */
  ...
  /**
   * Gets the height of the element’s content rectangle in the block-progression direction (Height). The default value is {@link #HEIGHT_AUTO}.
   * 
  ...
  /**
   * Sets the height of the element’s content rectangle in the block-progression direction (Height) to {@link #HEIGHT_AUTO}.
   */
  ...
  /**
   * Gets the alignment, in the inline-progression direction, of content within the table cell (InlineAlign). The default value is
  ...
  /**
   * Gets the offset to account for the separation between the table cell’s content rectangle and the surrounding border (TPadding). The default value
   * is 0.
   * 
  ...
  /**
   * Gets the distance by which the element’s baseline shall be shifted relative to that of its parent element (BaselineShift). The default value is
   * 0.
   * 
  ...
  /**
   * Gets the element’s preferred height in the block-progression direction (LineHeight). The default value is {@link #LINE_HEIGHT_NORMAL}.
   * 
  ...
  /**
   * Sets the element’s preferred height in the block-progression direction (LineHeight) to {@link #LINE_HEIGHT_NORMAL}.
   */
  ...
  /**
   * Sets the element’s preferred height in the block-progression direction (LineHeight) to {@link #LINE_HEIGHT_AUTO}.
   */
  ...
  /**
   * Gets the type of text decoration (TextDecorationType). The default value is {@link #TEXT_DECORATION_TYPE_NONE}.
   * 
  ...
  /**
   * Gets the justification of the lines within a ruby assembly (RubyAlign). The default value is {@link #RUBY_ALIGN_DISTRIBUTE}.
   * 
  ...
  /**
   * Gets the placement of the RT structure element relative to the RB element in a ruby assembly (RubyPosition). The default value is
  ...
  /**
   * Sets the orientation of glyphs when the inline-progression direction is top to bottom or bottom to top (GlyphOrientationVertical). The value
   * should be one of:
   * <ul>
  ...
  /**
   * Sets the desired space between adjacent columns in the inline-progression direction (ColumnGap), the first element specifying the space between
   * the first and second columns, the second specifying the space between the second and third columns, and so on.
   * 
