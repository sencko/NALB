...
/**
 * This class is a convenience for creating page content streams. You MUST call close() when you are finished with this object.
 * 
...
public class PDPageContentStream {
  ...
  /**
   * Append a cubic Bézier curve to the current path. The curve extends from the current point to the point (x3 , y3 ), using (x1 , y1 ) and (x2 , y2
  ...
  /**
   * Append a cubic Bézier curve to the current path. The curve extends from the current point to the point (x3 , y3 ), using the current point and
  ...
  /**
   * Append a cubic Bézier curve to the current path. The curve extends from the current point to the point (x3 , y3 ), using (x1 , y1 ) and (x3 , y3
   * ) as the Bézier control points
   * 
   * @param x1 x coordinate of the point 1
   * @param y1 y coordinate of the point 1
