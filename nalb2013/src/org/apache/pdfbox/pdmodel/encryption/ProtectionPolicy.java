...
public abstract class ProtectionPolicy {
  ...
  /**
   * set the length in (bits) of the secret key that will be used to encrypt document data. The default value is 40 bits, which provides a low
   * security level but is compatible with old versions of Acrobat Reader.
   * 
