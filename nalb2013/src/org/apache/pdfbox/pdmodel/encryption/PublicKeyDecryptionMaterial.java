 ...
 * 
 * The following example shows how to decrypt a document using a PKCS#12 certificate (typically files with a pfx extension).
 * 
 * <pre>
...
public class PublicKeyDecryptionMaterial extends DecryptionMaterial {
   ...
   * @param a The alias of the private key and the certificate. If the keystore contains only 1 entry, this parameter can be left null.
