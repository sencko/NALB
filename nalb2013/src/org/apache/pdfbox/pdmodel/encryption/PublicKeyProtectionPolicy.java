...
/**
 * This class represents the protection policy to use to protect a document with the public key security handler as described in the PDF specification
 * 1.6 p104.
 * 
 ...
 * 
 * The following code sample shows how to protect a document using the public key security handler. In this code sample, <code>doc</code> is a
 * <code>PDDocument</code> object.
 * 
 * <pre>
