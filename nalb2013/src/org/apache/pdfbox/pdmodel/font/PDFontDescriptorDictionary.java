...
public class PDFontDescriptorDictionary extends PDFontDescriptor implements COSObjectable {
  ...
  public float getCapHeight() {
    if (capHeight == Float.NEGATIVE_INFINITY) {
      /*
       * We observed a negative value being returned with the Scheherazade font. PDFBOX-429 was logged for this. We are not sure if returning the
       * absolute value is the correct fix, but it seems to work.
       */
