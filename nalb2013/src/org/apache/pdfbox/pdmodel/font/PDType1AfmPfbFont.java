...
public class PDType1AfmPfbFont extends PDType1Font {
  ...
  /*
   * This will generate a Encoding from the AFM-Encoding, because the AFM-Enconding isn't exported to the pdf and consequently the StandardEncoding is
   * used so that any special character is missing I've copied the code from the pdfbox-forum posted by V0JT4 and made some additions concerning
   * german umlauts see also https://sourceforge.net/forum/message.php?msg_id=4705274
   */
