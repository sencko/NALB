...
public class PDPageAdditionalActions implements COSObjectable {
  ...
  /**
   * This will get an action to be performed when the page is opened. This action is independent of any that may be defined by the OpenAction entry in
   * the document catalog, and is executed after such an action.
   * 
  ...
  /**
   * This will set an action to be performed when the page is opened. This action is independent of any that may be defined by the OpenAction entry in
   * the document catalog, and is executed after such an action.
   * 
  ...
  /**
   * This will get an action to be performed when the page is closed. This action applies to the page being closed, and is executed before any other
   * page opened.
   * 
  ...
  /**
   * This will set an action to be performed when the page is closed. This action applies to the page being closed, and is executed before any other
   * page opened.
   * 
