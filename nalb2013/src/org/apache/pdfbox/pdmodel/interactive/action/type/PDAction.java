...
public abstract class PDAction implements PDDestinationOrAction {
  ...
  /**
   * This will get the next action, or sequence of actions, to be performed after this one. The value is either a single action dictionary or an array
   * of action dictionaries to be performed in order.
   * 
  ...
  /**
   * This will set the next action, or sequence of actions, to be performed after this one. The value is either a single action dictionary or an array
   * of action dictionaries to be performed in order.
   * 
