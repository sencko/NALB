...
public class PDActionRemoteGoTo extends PDAction {
  ...
  /**
   * This will get the destination to jump to. If the value is an array defining an explicit destination, its first element must be a page number
  ...
  /**
   * This will set the destination to jump to. If the value is an array defining an explicit destination, its first element must be a page number
   * within the remote document rather than an indirect reference to a page object in the current document. The first page is numbered 0.
   * 
