...
/**
 * This class represents the additonal fields of a Markup type Annotation. See section 12.5.6 of ISO32000-1:2008 (starting with page 390) for details
 * on annotation types.
 * 
 * @author Paul King
...
public class PDAnnotationMarkup extends PDAnnotation {
  ...
  /**
   * This will retrieve the intent of the annotation The values and meanings are specific to the actual annotation See the IT_* constants for the
   * annotation classes.
   * 
   * @return the intent
   */
  ...
  /**
   * This will set the intent of the annotation The values and meanings are specific to the actual annotation See the IT_* constants for the
   * annotation classes.
   * 
   * @param it the intent
   */
