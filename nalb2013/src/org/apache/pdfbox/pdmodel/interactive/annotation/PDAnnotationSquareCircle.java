...
public class PDAnnotationSquareCircle extends PDAnnotationMarkup {
   ...
   * 
   * @param ic colour in the DeviceRGB colourspace.
   * 
   */
  ...
  /**
   * This will set the rectangle difference rectangle. Giving the difference between the annotations rectangle and where the drawing occurs. (To take
   * account of any effects applied through the BE entry forexample)
   * 
  ...
  /**
   * This will get the rectangle difference rectangle. Giving the difference between the annotations rectangle and where the drawing occurs. (To take
   * account of any effects applied through the BE entry forexample)
   * 
