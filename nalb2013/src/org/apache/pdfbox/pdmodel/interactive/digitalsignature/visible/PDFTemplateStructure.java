...
public class PDFTemplateStructure {
  ...
  /**
   * Gets Dictionary of AcroForm. Thats <b> /DR </b> entry in the AcroForm
   * 
   * @return
   */
  ...
  /**
   * Gets Holder form. That form is here <b> AcroForm/DR/XObject/{holder form name} </b> By default, name stars with FRM. We also add number of form
   * to the name.
   * 
   * @return
   */
  ...
  /**
   * Gets AppearanceDictionary That is <b>/AP</b> entry the appearance dictionary.
   * 
   * @return
   */
  ...
  /**
   * Gets inner form that is in this location: <b> AcroForm/DR/XObject/{holder form name}/Resources/XObject/{inner name} </b> By default inner form
   * name starts with "n". Then we add number of form to the name.
   * 
   * @return
   */
  ...
  /**
   * Gets Image form. Image form is in this structure: <b>/AcroForm/DR/{holder form}/Resources/XObject /{inner form} </b> /Resources/XObject/{image
   * form name}.
   * 
   * @return
   */
  ...
  /**
   * Sets Image form. Image form will be in this structure: <b>/AcroForm/DR/{holder form}/Resources/XObject /{inner form} /Resources/XObject/{image
   * form name}.</b> By default we start image form name with "img". Then we add number of image form to the form name. Sets image form
   * 
   * @param imageForm
   */
  ...
  /**
   * Gets Widget Dictionary. {@link org.apache.pdfbox.pdmodel.interactive.form.PDField}
   * 
  ...
  /**
   * Sets Widget Dictionary. {@link org.apache.pdfbox.pdmodel.interactive.form.PDField}
   * 
   * @see org.apache.pdfbox.pdmodel.interactive.form.PDField.getWidget()
