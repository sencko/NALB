...
public class PDOutlineItem extends PDOutlineNode {
  ...
  /**
   * This method will attempt to find the page in this PDF document that this outline points to. If the outline does not point to anything then this
   * method will return null. If the outline is an action that is not a GoTo action then this methods will throw the OutlineNotLocationException
   * 
