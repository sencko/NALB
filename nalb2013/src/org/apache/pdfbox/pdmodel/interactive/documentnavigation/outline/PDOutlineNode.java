...
public class PDOutlineNode implements COSObjectable {
   ...
   * 
   * @return The parent of this object, or null if this is the document outline and there is no parent.
   */
  ...
  /**
   * Get the number of open nodes. Or a negative number if this node is closed. See PDF Reference for more details. This value is updated as you
   * append children and siblings.
   * 
  ...
  /**
   * This will set this node to be open when it is shown in the viewer. By default, when a new node is created it will be closed. This will do nothing
  ...
  /**
   * The count parameter needs to be updated when you add or remove elements to the outline. When you add an element at a lower level then you need to
