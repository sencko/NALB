...
public abstract class PDField implements COSObjectable {
   ...
   * This method will return only the direct value on this object. Use the findFieldType for an upward recursive search.
   * 
  ...
  /**
   * Find the field type and optionally do a recursive upward search. Sometimes the fieldtype will be specified on the parent instead of the direct
   * object. This will look at this object for the field type, if none is specified then it will look to the parent if there is a parent. If there is
   * no parent and no field type has been found then this will return null.
   * 
  ...
  /**
   * This will get the single associated widget that is part of this field. This occurs when the Widget is embedded in the fields dictionary.
   * Sometimes there are multiple sub widgets associated with this field, in which case you want to use getKids(). If the kids entry is specified,
   * then the first entry in that list will be returned.
   * 
   ...
   * to start in that array. This method is called recursively until it finds the end point based on the name array.
   * 
  ...
  /**
   * This will get all the kids of this field. The values in the list will either be PDWidget or PDField. Normally they will be PDWidget objects
