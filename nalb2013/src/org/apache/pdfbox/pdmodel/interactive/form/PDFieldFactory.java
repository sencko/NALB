...
public class PDFieldFactory {
  ...
  /**
   * This method creates a COSField subclass from the given field. The field is a PDF Dictionary object that must represent a field element. -
  ...
  /**
   * This method determines if the given field is a radiobutton collection.
   * 
  ...
  /**
   * This method determines if the given field is a pushbutton.
   * 
   * @param flags The field flags.
   * 
   * @return the result of the determination
  ...
  /**
   * This method determines if the given field is a choicefield Choicefields are either listboxes or comboboxes.
   * 
