...
public class PDRadioCollection extends PDChoiceButton {
   ...
   * If set, a group of radio buttons within a radio button field that use the same value for the on state will turn on and off in unison; that is if
   * one is checked, they are all checked. If clear, the buttons are mutually exclusive (the same behavior as HTML radio buttons).
   * 
  ...
  /**
   * This setValue method iterates the collection of radiobuttons and checks or unchecks each radiobutton according to the given value. If the value
   * is not represented by any of the radiobuttons, then none will be checked.
   * 
   * {@inheritDoc}
   */
  @Override
