...
public class LayerUtility {
  ...
  /**
   * Some applications may not wrap their page content in a save/restore (q/Q) pair which can lead to problems with coordinate system transformations
   * when content is appended. This method lets you add a q/Q pair around the existing page's content.
   * 
   * @param page the page
  ...
  private static final Set<String> PAGE_TO_FORM_FILTER = new java.util.HashSet<String>(Arrays.asList(new String[] { "Group", "LastModified",
      "Metadata" }));
  ...
  /**
   * Places the given form over the existing content of the indicated page (like an overlay). The form is enveloped in a marked content section to
   * indicate that it's part of an optional content group (OCG), here used as a layer. This optional group is returned and can be enabled and disabled
   * through methods on {@link PDOptionalContentProperties}.
   * 
