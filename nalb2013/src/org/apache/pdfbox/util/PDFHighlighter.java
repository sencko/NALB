 ...
 * 
 * @see <a href="http://partners.adobe.com/public/developer/en/pdf/HighlightFileFormat.pdf"> Adobe Highlight File Format</a>
 */
public class PDFHighlighter extends PDFTextStripper {
   ...
   */
  /*
   * public void setHighlightColor( String color ) { highlightColor = Color.decode( color ); }*
   */
   ...
   */
  /*
   * public String getHighlightColorAsString() { //BJL: kudos to anyone that has a cleaner way of doing this! String red = Integer.toHexString(
   * highlightColor.getRed() ); String green = Integer.toHexString( highlightColor.getGreen() ); String blue = Integer.toHexString(
