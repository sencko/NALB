...
public class PDFTextStripperByArea extends PDFTextStripper {
  ...
  /**
   * Instantiate a new PDFTextStripperArea object. Loading all of the operator mappings from the properties object that is passed in. Does not convert
  ...
  /**
   * Instantiate a new PDFTextStripperArea object. This object will load properties from PDFTextStripper.properties and will apply encoding-specific
