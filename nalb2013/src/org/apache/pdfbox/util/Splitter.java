...
public class Splitter {
  ...
  /**
   * This will tell the splitting algorithm where to split the pages. The default is 1, so every page will become a new document. If it was to then
   * each document would contain 2 pages. So it the source document had 5 pages it would split into 3 new documents, 2 documents containing 2 pages
   * and 1 document containing one page.
   * 
  ...
  /**
   * Interface method, you can control where a document gets split by implementing this method. By default a split occurs at every page. If you wanted
   * to split based on some complex logic then you could override this method. For example. <code>
